...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_core_js_es6_promise__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__gameState__ = __webpack_require__(77);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__gameLogic__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__gameView__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__scss_style_scss__ = __webpack_require__(92);
...
var gameState = Object(__WEBPACK_IMPORTED_MODULE_2__gameState__["a" /* default */])();
var gameLogic = Object(__WEBPACK_IMPORTED_MODULE_3__gameLogic__["a" /* default */])();
var gameView = Object(__WEBPACK_IMPORTED_MODULE_4__gameView__["a" /* default */])(gameLogic, gameState);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process, setImmediate) {/* harmony export (immutable) */ __webpack_exports__["a"] = GameLogic;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__playerFunctions__ = __webpack_require__(80);
...
var playerFunctions = Object(__WEBPACK_IMPORTED_MODULE_0__playerFunctions__["a" /* default */])();
...
function GameLogic() {
  ...
  var bootCPU = function bootCPU() {
    var state = {
      pattern: [],
      cadence: 900
    };
    return Object.assign({}, state, playerFunctions.canGenRandomStep(state), playerFunctions.canPlayBackPattern(state)(view.colorButtonComponents), playerFunctions.canClearPattern(state));
  };

  var bootUserInterface = function bootUserInterface() {
    var state = {
      pattern: [],
      cadence: 1
    };
    return Object.assign({}, state, playerFunctions.canAddStepFromUser(state), playerFunctions.canPlayBackPattern(state)(view.colorButtonComponents), playerFunctions.canClearPattern(state));
  };
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process, setImmediate) {/* harmony export (immutable) */ __webpack_exports__["a"] = GameView;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_howler_dist_howler_core_min__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_howler_dist_howler_core_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_howler_dist_howler_core_min__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__animations__ = __webpack_require__(84);
var _typeof = typeof Symbol === "function" && typeof Symbol.iterator === "symbol" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; };
...
var animations = Object(__WEBPACK_IMPORTED_MODULE_1__animations__["a" /* default */])();

function GameView(logic, model) {
  var state = {
  ...
  function ColorButton(node) {
    var el = node,
        ...
        sound = new __WEBPACK_IMPORTED_MODULE_0_howler_dist_howler_core_min__["Howl"]({ src: __webpack_require__(87)("./simonSound" + name + '.mp3') }),
    ...
    function glow() {
      return new Promise(function ($return, $error) {
        ...
        return lighten().then(function ($await_1) {
          removeLighten();
          return $return();
        }.$asyncbind(this, $error), $error);
      }.$asyncbind(this));
  ...
  (function bindEvents() {
    state.restartEl.addEventListener('click', function restart() {
      logic.resetGame();
      logic.delayStart().then(function () {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_kute_js__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_kute_js_kute_svg__ = __webpack_require__(85);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_kute_js_kute_attr__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_kute_js_kute_attr___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_kute_js_kute_attr__);
...
function Animations() {
  ...
  function simonMorphTo(toKey) {
    var messages = {
      simon: simon,
      simonAttrCopy: simonAttrCopy,
      you: you,
      reset: reset,
      win: win
    };

    var toObj = messages[toKey];

    for (var i = 0, keys = Object.keys(toObj); i < keys.length; i++) {
      __WEBPACK_IMPORTED_MODULE_0_kute_js___default.a.to(simon[keys[i]].el, { path: toObj[keys[i]].path(), attr: { fill: toObj[keys[i]].fill(), strokeWidth: toObj[keys[i]].strokeWidth() } }, { morphPrecision: 6, morphIndex: 400, duration: 1000 }).start();
    }
  }

  return {
    simonMorphTo: simonMorphTo
  };
}
